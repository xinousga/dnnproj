            ...
            <td class="Forum_UCP_Right">
                <table cellspacing="0" cellpadding="0" border="0" width="100%">
                    ...
                    <tr>
                            ...
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td class="Forum_Tab_Left">
                                        <asp:LinkButton ID="cmdGeneral" runat="server" CssClass="Forum_Link" resourcekey="cmdGeneral" CausesValidation="false" />
                                    </td>
                                    <td class="Forum_Tab">
								<asp:LinkButton ID="cmdBehavior" runat="server" CssClass="Forum_Link" resourcekey="cmdBehavior" CausesValidation="false" />
                                    </td>
                                    <td class="Forum_Tab_Right">
                                        <asp:LinkButton ID="cmdEmail" runat="server" CssClass="Forum_Link" resourcekey="cmdEmail" CausesValidation="false" />
                                    </td>
                                </tr>
                            </table>
                            <table id="tblGeneral" cellspacing="0" cellpadding="0" width="100%" runat="server">
						<tr id="rowForumID" runat="server" visible="False">
						    <td class="Forum_Row_AdminL" width="150">
							   <span class="Forum_Row_AdminText">
								  <dnn:label id="plForumID" runat="server" controlname="txtForumID"></dnn:label>
							   </span>
						    </td>
						    <td class="Forum_Row_AdminR" width="250" align="left">
						...
						<tr>
						    <td class="Forum_Row_AdminL" width="150" valign="top">
							   <span class="Forum_Row_AdminText">
						...
						<tr>
                            ...
                            <table id="tblBehavior" cellspacing="0" cellpadding="0" width="100%" runat="server">
						<tr>
						    <td class="Forum_Row_AdminL" width="150">
							   <span class="Forum_Row_AdminText">
						...
						<tr id="rowPermissions" runat="server">
						    <td class="Forum_Row_Admin" align="center" valign="top" colspan="2">
							   <br />
					   ...
					   <table id="tblEmail" cellspacing="0" cellpadding="0" width="100%" runat="server">
				   		<tr>
						     <td class="Forum_Row_AdminL" width="150">
								<span class="Forum_Row_AdminText">
						...
						<tr runat="server" id="row6" visible="false">
							   <td class="Forum_Row_AdminL" width="150">
								   <span class="Forum_Row_AdminText">
						   ...
						   <tr runat="server" id="row7" visible="false">
							   <td class="Forum_Row_AdminL" width="150">
								   <span class="Forum_Row_AdminText">
						...
						<tr runat="server" id="rowEmailServer">
							<td class="Forum_Row_AdminL" width="150">
						...
						<tr runat="server" id="rowEmailUser">
							<td class="Forum_Row_AdminL" width="150">
						...
						<tr runat="server" id="rowEmailPass">
							<td class="Forum_Row_AdminL" width="150">
						...
						<tr runat="server" id="rowEmailPort">
							<td class="Forum_Row_AdminL" width="150">
						...
						<tr runat="server" id="rowEmailSSL">
							<td class="Forum_Row_AdminL" width="150">
