...
<table cellpadding="0" cellspacing="0" width="100%" border="0">
	<tr>
     ...
     <tr>
		<td>    
		     <table id="tblUI" cellspacing="0" cellpadding="0" width="100%" runat="server">
			     <tr>
			     ...
			     <tr>
                    ...
                    <tr>
                         <td class="Forum_Row_AdminL" width="35%">
                              <span class="Forum_Row_AdminText">
                                   <dnn:Label ID="plEnableScripts" runat="server" ControlName="chkEnableScripts" Suffix=":"></dnn:Label>
                              </span>
                         </td>
                         <td align="left" class="Forum_Row_AdminR">
					     <asp:checkbox id="chkEnableScripts" runat="server" CssClass="Forum_NormalTextBox" />
					</td>
                    </tr>
                    <tr>
                         <td class="Forum_Row_AdminL" width="35%">
