...
<%@ Control language="vb" CodeBehind="Forum_PostModerate.ascx.vb" AutoEventWireup="false" Inherits="DotNetNuke.Modules.Forum.PostModerate" %>
<link href="<%= ForumConfig.Css() %>" type="text/css" rel="stylesheet" />
	<table class="Forum_Container" id="tblMain" cellspacing="0" cellpadding="0" width="100%"
			...
			<td width="100%">
				<table cellspacing="0" cellpadding="0" width="100%" border="0">
					<tr>
						...
						<td class="Forum_Header">&nbsp;<asp:hyperlink id="hlForum" CssClass="Forum_HeaderText" Runat="server" Target="_blank"></asp:hyperlink></td>
		...
		<tr>
			<td valign="top" align="left" width="100%"><asp:datalist id="lstPost" runat="server" DataKeyField="PostID" CellPadding="0" Width="100%">
					<ItemTemplate>
		...
		<tr id="rowBottomFooter" runat="server">
