...
<asp:placeholder id="plhGrid" runat="server">
	...
	<asp:linkbutton id="btnAdd" tabIndex="1" cssclass="StoreAccountAddressesAddButton" runat="server" resourcekey="btnAdd" onclick="btnAdd_Click">Add Address</asp:linkbutton><br />
</asp:placeholder>
	...
	<table class="StoreAccountAddressCmd">
		<tr>
			<td class="StoreAddressLabel">
				<dnn:label id="lblPrimary" runat="server" controlname="chkPrimary"></dnn:label>
			</td>
			<td class="StoreAddressField">
				<asp:checkbox id="chkPrimary" tabIndex="20" runat="server"></asp:checkbox>
			</td>
		</tr>
		<tr>
