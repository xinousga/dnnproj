            ...
            <tr>
                <td vAlign="top" noWrap align="center">
                    <table cellSpacing="3" cellPadding="0" border="0">
                        <tr>
                            <td width="100" class="NormalBold" nowrap>
                                <dnn:label id="lblStatus" runat="server" controlname="lblStatus" suffix=":" CssClass="NormalBold"></dnn:label>
                            </td>
                            <td>
                        ...
                        <tr>
                            <td width="100" class="NormalBold" nowrap>
                                <dnn:label id="lblCategory" runat="server" controlname="lblCategory" suffix=":" CssClass="NormalBold"></dnn:label>
                            </td>
                            <td>
                                <asp:DropDownList id="cmbCategory" runat="server" Width="200" AutoPostBack="true" DataTextField="CategoryName" DataValueField="CategoryID" onselectedindexchanged="cmbCategory_SelectedIndexChanged"></asp:DropDownList>
                            </td>
                        </tr>
                        <tr>
                            <td width="100" class="NormalBold" nowrap>
                                <dnn:label id="lblProduct" runat="server" controlname="lblProduct" suffix=":" CssClass="NormalBold"></dnn:label>
                            </td>
                            <td>
                                <asp:DropDownList id="cmbProduct" runat="server" Width="200" AutoPostBack="true" DataTextField="ProductTitle" DataValueField="ProductID" onselectedindexchanged="cmbProduct_SelectedIndexChanged"></asp:DropDownList>
                            </td>
                        </tr>
                    </table>
                    <br />
                    <asp:datagrid id="grdReviews" runat="server" showheader="true" showfooter="false" autogeneratecolumns="false" width="500" AllowPaging="True" PageSize="20">
                        <columns>
                            <asp:TemplateColumn>
                                <HeaderTemplate>
