...
<dnn:label id="lblParentTitle" runat="server" controlname="lblParentTitle" visible="False"></dnn:label>
                ...
                <table cellspacing="3" cellpadding="0" border="0">
                    <tr>
                        <td class="NormalBold" style="width:150px;">
                            <dnn:label id="lblCategory" controlname="lblCategory" runat="server" cssclass="NormalBold" suffix=":"></dnn:label>
                        </td>
                        <td>
