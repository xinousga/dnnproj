...
<div class="StoreMenuWrapper">
    <asp:datalist id="MyList" runat="server" cellpadding="3" cellspacing="0" width="100%" datakeyfield="CategoryID" repeatcolumns="1">
        <SelectedItemTemplate>
            ...
            <asp:HyperLink id="linkCategory" CssClass="StoreMenuCategoryItem" Runat="server"><%# DataBinder.Eval(Container.DataItem, "CategoryName") %></asp:HyperLink>
        </SelectedItemTemplate>
        <ItemTemplate>
