...
Namespace ArtMenuSkinObject
    ...
    Partial Public Class ArtMenuSO
        ...
        Private Function GetVMenuBlock() As Dictionary(Of String, String)
            ...
            parts.Add("VMenuBlockBegin", "<div class=""art-vmenublock"">" & vbNewLine & _ 
"    <div class=""art-vmenublock-body"">" & vbNewLine & _ 
"")
            parts.Add("VMenuBlockEnd", "" & vbNewLine & _ 
"		<div class=""cleared""></div>" & vbNewLine & _ 
"    </div>" & vbNewLine & _ 
"</div>" & vbNewLine & _ 
"")
            parts.Add("VMenuBlockHeaderBegin", "<div class=""art-vmenublockheader"">" & vbNewLine & _ 
"    <div class=""l""></div>" & vbNewLine & _ 
"    <div class=""r""></div>" & vbNewLine & _ 
"     <div class=""t"">")
            parts.Add("VMenuBlockHeaderEnd", "</div>" & vbNewLine & _ 
"</div>" & vbNewLine & _ 
"")
            parts.Add("VMenuBlockContentBegin", "<div class=""art-vmenublockcontent"">" & vbNewLine & _ 
"    <div class=""art-vmenublockcontent-body"">" & vbNewLine & _ 
"<!-- block-content -->" & vbNewLine & _ 
"")
            parts.Add("VMenuBlockContentEnd", "" & vbNewLine & _ 
"<!-- /block-content -->" & vbNewLine & _ 
"" & vbNewLine & _ 
"		<div class=""cleared""></div>" & vbNewLine & _ 
"    </div>" & vbNewLine & _ 
