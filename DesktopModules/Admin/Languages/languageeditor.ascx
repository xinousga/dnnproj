...
<table cellspacing="5" border="0">
    <tr>
        <td valign="top" nowrap="nowrap" width="200px">
            ...
            <br />
            <asp:DropDownList ID="cboLocales" runat="server" AutoPostBack="true" />
            <br />
            <dnn:CommandButton ID="cmdEdit" runat="server" CssClass="CommandButton" resourcekey="cmdEdit" ImageUrl="~/images/edit.gif" />&nbsp;
            <br />
            <br />
            <br />
        ...
        <td style="vertical-align:top;width:99%">
            <table border="0">
                <tr id="rowMode" runat="server">
                    <td class="SubHead"><dnn:Label ID="plMode" runat="server" Text="Available Locales" ControlName="cboLocales" /></td>
                    <td>
                ...
                <tr>
                    <td class="SubHead" colspan="2"><asp:CheckBox ID="chkHighlight" runat="server" resourcekey="Highlight" AutoPostBack="True" TextAlign="Left" /></td>
                </tr>
                <tr height="20px"><td></td></tr>
                <tr>
                    <td class="SubHead"><dnn:Label ID="plSelected" runat="server" ControlName="lblResourceFile" /></td>
                    <td valign="top"><asp:Label ID="lblResourceFile" runat="server" CssClass="NormalBold" /></td>
                </tr>
           </table>
           <br />
			<asp:DataGrid ID="dgEditor" runat="server" CssClass="Normal" GridLines="None" CellPadding="2" CellSpacing="0"
				AutoGenerateColumns="False" AllowPaging="true" AllowCustomPaging="false" ShowHeader="true" 
				ShowFooter="false" PagerStyle-Visible="false" Width="100%">
				...
				<Columns>
					...
					<asp:TemplateColumn>
						...
						<ItemTemplate>
							<asp:TextBox ID="txtDefault" Width="90%" runat="server" TextMode="MultiLine" Height="30px" ReadOnly="true" BorderColor="#f7f7f7" BorderStyle="solid" BorderWidth="1px"></asp:TextBox>
							<asp:Image runat="server" AlternateText="View" ID="imgView" ImageUrl="~/images/view.gif" resourcekey="cmdView" style="vertical-align:top" Visible="false"></asp:Image>
						</ItemTemplate>
					</asp:TemplateColumn>
				</Columns>
			</asp:DataGrid>
