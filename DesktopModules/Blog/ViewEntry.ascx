				...
				<asp:Panel id="divBlogBubble" runat="server" CssClass="blog_bubble">
					<blockquote>
						...
						<p>
							...
							<asp:imagebutton id=lnkApproveComment runat="server" visible="false" commandargument='<%# DataBinder.Eval(Container.DataItem, "CommentID") %>' commandname="ApproveComment" imageurl="~/desktopmodules/Blog/images/blog_accept.png" ImageAlign="AbsMiddle">
							</asp:imagebutton>
							<asp:LinkButton ID="btApproveComment" Runat="server" Visible="False" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "CommentID") %>' commandname="ApproveComment" resourcekey="Approve" CssClass="CommandButton">Approve</asp:LinkButton>
