...
<div id="sidebar1" visible="true" runat="server"><dnn:ARTMENU ID="ArtVMenu1" ShowHiddenTabs="False" ShowAdminTabs="True" ShowDeletedTabs="False" ShowLoginTab="True" ShowUserTab="True" Orientation="Vertical" Caption="Navigation" runat="server" /></div>
</div>
