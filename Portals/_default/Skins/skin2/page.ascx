...
<div class="art-logo">
 <h1 id="name-text" class="art-logo-name"><a href="<%= DotNetNuke.Common.Globals.NavigateURL(Me.PortalSettings.HomeTabId) %>">大字标题</a></h1>
 <div id="slogan-text" class="art-logo-text">标语文字</div>
</div>
...
<div id="sidebar1" visible="true" runat="server"><dnn:ARTMENU ID="ArtVMenu1" ShowHiddenTabs="False" ShowAdminTabs="True" ShowDeletedTabs="False" ShowLoginTab="True" ShowUserTab="True" Orientation="Vertical" Caption="" runat="server" /></div>
</div>
...
<div id="sidebar2" visible="true" runat="server"></div>
</div>
